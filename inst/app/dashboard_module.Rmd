...
burro:::cat_single_server("category", categoricalVars, dataOut)
```
...
burro:::cat_outcome_server("outcome", outcome_var, cat_no_outcome, dataOut)
```
...
```{r}
cont_hist_ui("histogram", numericVars)
cont_hist_server("histogram", dataOut)
```

### Boxplot Explorer

```{r}
cont_boxplot_ui(id="boxplot", numericVars, categoricalVars)
cont_boxplot_server(id="boxplot", dataOut)
```

### Correlation Explorer

```{r}
cont_scatter_ui(id="corr_plot", numericVars)
cont_scatter_server(id="corr_plot", dataOut)
```
